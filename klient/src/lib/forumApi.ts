...
export type ForumPost = {
  ...
  topic: string;
  created_at: string;
  author: { id: number; first_name: string; last_name: string; role: "student"|"researcher"|"admin"; university?: string };
...
export async function createPost(payload: {
  title: string; summary: string; body: string; topic: string; university?: string
}) {
...
export async function react(postId: number, type: string) {
